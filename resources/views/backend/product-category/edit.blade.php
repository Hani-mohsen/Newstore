...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                <a href="{{ route('pro.index') }}" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('pro.update',$productCategory->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-6">
                ...
                initialPreviewConfig:[
                    {
                        ...
                        size:'1111',
                        width:"120px",
                        url: "{{ route('pro.edit', ['product_category_id' => $productCategory->id, '_token' => csrf_token()]) }}",

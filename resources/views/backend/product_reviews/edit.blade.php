...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Edit review on product {{ $productReview->name }}</h6>
            <div class="ml-auto">
            ...
            <form action="" method="post">
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <input type="text" value="{{ $productReview->name }}" class="form-control" readonly>
                        <input type="hidden" name="product_id" value="{{ $productReview->product_id }}" class="form-control" readonly>
                        @error('product_id')<span class="text-danger">{{ $message }}</span>@enderror
                    </div>
                    <div class="col-4">
                        <label for="user_id">Customer</label>
                        <input type="text" value="{{ $productReview->id != '' ? $productReview->name : '' }}" class="form-control" readonly>

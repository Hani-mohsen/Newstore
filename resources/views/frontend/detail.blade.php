                            ...
                            <div class="swiper product-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                ...
                                                class="img-fluid" src="{{asset('frontend/img/product-detail-1.jpg')}}" alt="..."></a></div>
                                    <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                                        href="{{asset('frontend/img/product-detail-2.jpg')}}"
                                                                        data-gallery="gallery2"
                                                                        data-glightbox="Product item 2"><img
                                                class="img-fluid" src="{{asset('frontend/img/product-detail-2.jpg')}}" alt="..."></a></div>
                                    <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                                        href="{{asset('frontend/img/product-detail-3.jpg')}}"
                                                                        data-gallery="gallery2"
                                                                        data-glightbox="Product item 3"><img
                                                class="img-fluid" src="{{asset('frontend/img/product-detail-3.jpg')}}" alt="..."></a></div>
                                    <div class="swiper-slide h-auto"><a class="glightbox product-view"
                                                                        href="{{asset('frontend/img/product-detail-4.jpg')}}"
                                                                        data-gallery="gallery2"
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0"><img class="rounded-circle" src="{{asset('frontend/img/customer-1.png')}}"
                                                                    alt="" width="50"/></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product text-center skel-loader">
                        <div class="d-block mb-3 position-relative"><a class="d-block" href="{{route('frontend.detail')}}"><img
                            ...
                            <div class="product-overlay">
                                <ul class="mb-0 list-inline">
                                    ...
                                    <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="{{route('frontend.cart')}}">Add to
                                            cart</a></li>

...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                <a href="{{ route('pro.create') }}" class="btn btn-primary">
    ...
    @include('backend.product-category.filter.filter')
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{route('pro.edit')}}" class="btn btn-primary">
                            ...
                            <form action="" method="post" id="delete-product-category-{{ $category->id }}" class="d-none">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
